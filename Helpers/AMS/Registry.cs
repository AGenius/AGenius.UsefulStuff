/*
 * AGenius.UsefulStuff.AMS.Profile Class Library
 * 
 * Written by Alvaro Mendez
 * Copyright (c) 2005. All Rights Reserved.
 * 
 * The AGenius.UsefulStuff.AMS.Profile namespace contains interfaces and classes that 
...
namespace AGenius.UsefulStuff.AMS.Profile
{
    ...
    public class Registry : Profile
    {
        ...
        /// <summary>
        ///   Initializes a new instance of the Registry class by setting the <see cref="Profile.Name" /> to <see cref="Profile.DefaultName" />. </summary>
        public Registry(string ApplicationCompanyName, string ApplicationProductName)
        {
        ...
        ///   If not null, this is used to initialize the <see cref="Profile.Name" /> property. </param>
        ///   
        /// <param name="ApplicationCompanyName">
        ///   The Company Name</param>
        /// <param name="ApplicationProductName">
        ///   The Product Name</param>
        public Registry(RegistryKey rootKey, string subKeyName, string ApplicationCompanyName, string ApplicationProductName) : base("")
        {
            CompanyName = ApplicationCompanyName;
            ProductName = ApplicationProductName;
            this.Name = DefaultName;
        ...
        public Registry(Registry reg) : base(reg)
        {
