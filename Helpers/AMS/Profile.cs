...
namespace AGenius.UsefulStuff.AMS.Profile
{
    ...
    public abstract class Profile : IProfile
    {
        ...
        /// <summary>
        ///   Retrieves the DateTime value of an entry inside a section, or a default value if the entry does not exist. </summary>
        /// <param name="section">
        ///   The name of the section that holds the entry with the value. </param>
        /// <param name="entry">
        ///   The name of the entry where the value is stored. </param>
        ...
        /// <seealso cref="SetValue" />
        /// <seealso cref="HasEntry" />
        public virtual DateTime GetValue(string section, string entry, DateTime defaultValue)
        {
            object value = GetValue(section, entry);
            if (value == null)
                return defaultValue;
